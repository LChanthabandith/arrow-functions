...
// When joe.scope() is called, "this" refers to Joe.
//
// 2. What is "this" when joe.scopeArrow() is invoked?
// When joe.scopeArrow() is called, "this" is not about Joe anymore. Due to the way arrow functions work, "this" could be seen as referring to the entire world around Joe, not Joe himself.
//
// 3. Explain why "this" is different when an arrow function is used.
// Arrow functions in JavaScript have a special property. They don't really know who "this" is by themselves. Instead, they look at the environment around them to understand who "this" is. In contrast, regular functions have a stronger sense of self and "this" inside them usually refers to themselves.